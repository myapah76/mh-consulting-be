...
@Entity @Table(name = "consultation_requests")
...
public class ConsultationRequest {
    ...
    @Column(name = "service_title_snapshot", length = 200) private String serviceTitleSnapshot;
    @Column(columnDefinition = "text") private String message;
    @Enumerated(EnumType.STRING) @Column(nullable = false, length = 30) private ConsultationStatus status = ConsultationStatus.NEW;
