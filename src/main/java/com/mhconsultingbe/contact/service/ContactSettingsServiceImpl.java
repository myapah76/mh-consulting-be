...
public class ContactSettingsServiceImpl implements ContactSettingsService {
    ...
    public ContactSettingsResponse update(ContactSettingsRequest b) {
        ...
        s.setCompanyName(TextNormalizer.plainText(b.companyName()));
        s.setTagline(TextNormalizer.plainText(b.tagline()));
        s.setPrimaryPhone(TextNormalizer.trimToNull(b.primaryPhone()));
        s.setHotline1(TextNormalizer.trimToNull(b.hotline1()));
        s.setHotline2(TextNormalizer.trimToNull(b.hotline2()));
        s.setHotline3(TextNormalizer.trimToNull(b.hotline3()));
        s.setEmail(TextNormalizer.lowercase(b.email()));
        s.setAddress(TextNormalizer.plainText(b.address()));
        s.setZaloUrl(TextNormalizer.trimToNull(b.zaloUrl()));
        s.setFacebookUrl(TextNormalizer.trimToNull(b.facebookUrl()));
